...
public:
    ...
    virtual QString getPrint() const;

    QString modifyMemCPU (double);
    QString modifyMemGPU (double);
    QString modifyMemRAM (double);
    QString modifyMemMEM (double);
    void setMemCPU (double);
    void setMemGPU (double);
    void setMemRAM (double);
    void setMemMEM (double);

    QString modifyClockCPU (int);
    QString modifyClockGPU (int);
    QString modifyClockRAM (int);
    void setClockCPU (int);
    void setClockGPU (int);
    void setClockRAM (int);

    QString modifyCoresCPU (int);
    QString modifyCoresGPU (int);
    void setCoresCPU (int);
    void setCoresGPU (int);

    void setHyperCPU (bool);

    QString modifyBandGPU (int);
    void setBandGPU (int);

    QString modifyWriteSpeedMEM (int);
    QString modifyReadSpeedMEM (int);
